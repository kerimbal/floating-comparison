[![Build](https://github.com/kerimbal/floating-comparison/actions/workflows/build-test.yml/badge.svg)](https://github.com/kerimbal/floating-comparison/actions/workflows/build-test.yml)
